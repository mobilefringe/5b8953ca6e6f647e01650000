                ...
                <div class="main_container mobile_padding margin_30">
                    <div class="details_row">
                        <div class="details_col_3 hidden_phone">
                            <img class="img_max" src="//codecloud.cdn.speedyrails.net/sites/5b8953ca6e6f647e01650000/image/jpeg/1531500156000/sidebanner4.jpg" alt="" />    
                        </div>
        ...
        return Vue.component("leasing-temporary-component", {
            ...
            methods: {
                loadData: async function () {
                    ...
                    try {
                        let results = await Promise.all([this.$store.dispatch('LOAD_PAGE_DATA', { url: this.property.mm_host + "/pages/centennialmall-temporary-leasing.json"})]);
                        return results;
                    } catch (e) {
                ...
                validateBeforeSubmitTemp() {
                    ...
                    this.$validator.validate().then((result) => {
                        if (result) {
                            ...
                            temp_formdata.send_to = "huntleyj@davpart.com,centennialmall@davpart.com";
                            temp_formdata.subject = "Centennial Mall Temporary Leasing Form"; 
                            temp_formdata.body = {};
