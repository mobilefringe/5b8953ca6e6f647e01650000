        ...
        <section class="footer_menu main_container">
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4 footer_hours">
                    ...
                    <img src="//codecloud.cdn.speedyrails.net/sites/5b8953ca6e6f647e01650000/image/png/1525870162000/clock.png" class="clock_icon" alt="">
        ...
        <section class="footer_privacy ">
            <div class="main_container row">
                ...
                <div class="col-sm-8 col-md-6">
                    ...
                    <p class="footer_text"><a :href="'tel:' +  property.contact_phone">{{ property.contact_phone }}</a> | <a href="/pages/centennialmall-privacy-policy">Privacy Policy</a> | <router-link to="/jobs" exact>Jobs</router-link> | <a :href="siteInfo.propertyManagementURL" target="_blank">{{ siteInfo.propertyManagementName }}</a></p>
                </div>
            </div>
        </section>
    </footer>
