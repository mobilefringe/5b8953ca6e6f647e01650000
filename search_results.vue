            		...
            		<div class="page_container text-left" v-if="searchResults && searchResults.length > 0" id="searchResults">
            			...
            			<div v-for="(result,index) in searchResults" :key="index" >
                            <div class="row result_container_row">
                                <div v-if="results.store" class="col-md-3">
                                    <img class="result_logo" :src="result.store.store_front_url_abs"/>
                                </div>
                                <div v-else-if="result.store && _.includes(result.image_url,'missing')" class=" col-md-3 store_details_image center-block">
                                    <div class="no_logo">
                                ...
                                <div v-else-if="!results.store" class="col-md-3" v-else>
                                    <img v-if="result.store" class="result_logo" :src="//codecloud.cdn.speedyrails.net/sites/5b8953ca6e6f647e01650000/image/png/1535746524000/centennial_default-compressor.png"/>
                                </div>
